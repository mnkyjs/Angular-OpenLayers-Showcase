    ...
    [260],
    {
        728: () => {
                ...
                class v {
                    constructor(T, e, r) {
                        ...
                        (k || (e && e._hasTaskZS)) &&
                            ...
                            r.onScheduleTask ||
                                ((this._scheduleTaskZS = b), (this._scheduleTaskDlgt = e), (this._scheduleTaskCurrZone = this.zone)),
                            r.onInvokeTask ||
                                ((this._invokeTaskZS = b), (this._invokeTaskDlgt = e), (this._invokeTaskCurrZone = this.zone)),
                            r.onCancelTask ||
                                ((this._cancelTaskZS = b), (this._cancelTaskDlgt = e), (this._cancelTaskCurrZone = this.zone)));
                    }
                    fork(T, e) {
            ...
            const A = Zone.__symbol__,
                ...
                at = 'removeAttribute';
            function je(t, n) {
                for (let i = t.length - 1; i >= 0; i--) 'function' == typeof t[i] && (t[i] = Me(t[i], n + '_' + i));
                return t;
            }
            function Fe(t) {
            ...
            const Be = typeof WorkerGlobalScope < 'u' && self instanceof WorkerGlobalScope,
                ...
                Ue = typeof Y.process < 'u' && '[object process]' === {}.toString.call(Y.process) && !Be && !(!Pe || !_e.HTMLElement),
                Re = {},
                We = function (t) {
            ...
            function qe(t, n, i) {
                let o = fe(t, n);
                if ((!o && i && fe(i, n) && (o = { enumerable: !0, configurable: !0 }), !o || !o.configurable)) return;
                ...
                b || (b = Re[d] = A('ON_PROPERTY' + d)),
                    ...
                    (o.get = function () {
                        ...
                        if (a) {
                            let M = a.call(this);
                            if (M) return o.set.call(this, M), 'function' == typeof v[at] && v.removeAttribute(n), M;
                        }
                        return null;
                    }),
                    pe(t, n, o),
            ...
            function ut(t, n, i) {
                ...
                o = le(
                    ...
                    (a) =>
                        function (y, d) {
                            const b = i(y, d);
                            return b.cbIdx >= 0 && 'function' == typeof d[b.cbIdx] ? Le(b.name, d[b.cbIdx], b, c) : a.apply(y, d);
                        },
                );
            }
            function ue(t, n) {
            ...
            function ht() {
                ...
                try {
                    ...
                    (-1 !== t.indexOf('MSIE ') || -1 !== t.indexOf('Trident/') || -1 !== t.indexOf('Edge/')) && (He = !0);
                } catch {}
                return He;
            }
            Zone.__load_patch('ZoneAwarePromise', (t, n, i) => {
                ...
                function z(u, l, s) {
                    ...
                    if (u[q] === j) {
                        ...
                        if (l !== G && s instanceof e && s.hasOwnProperty(q) && s.hasOwnProperty(R) && s[q] !== j) oe(s), z(u, s[q], s[R]);
                            ...
                            u[q] = l;
                            const w = u[R];
                            if (((u[R] = s), u[_] === _ && l === E && ((u[q] = u[x]), (u[R] = u[J])), l === G && s instanceof Error)) {
                ...
                class e {
                    ...
                    static any(l) {
                        if (!l || 'function' != typeof l[Symbol.iterator]) return Promise.reject(new T([], 'All promises were rejected'));
                        const s = [];
                        let f = 0;
                        try {
                        ...
                        l = function (s, f, g, w, m = !1, S = !1) {
                            return function () {
                                ...
                                const he = Ee && !!u && -1 !== u.indexOf(Z),
                                    ...
                                    ke = ee && 'object' == typeof ee && ee.signal && 'object' == typeof ee.signal ? ee.signal : void 0;
                                ...
                                let Se,
                                    ...
                                    ot = !1;
                                if (ye) {
                                    if (((ot = !0), X)) for (let de = 0; de < ye.length; de++) if (C(ye[de], V)) return;
                                } else ye = D[rt] = [];
                            ...
                            c.forEach(function (p) {
                                ...
                                try {
                                    if (O.hasOwnProperty(p)) {
                                        ...
                                        N && N.value
                                            ? ((N.value = t.wrapWithCurrentZone(N.value, M)), t._redefineProperty(b.prototype, p, N))
            ...
            Zone.__load_patch('util', (t, n, i) => {
                const o = xe(t);
                (i.patchOnProperties = Xe), (i.patchMethod = le), (i.bindArguments = je), (i.patchMacroTask = ut);
                            ...
                            if ('function' == typeof M[0]) {
                                ...
                                M[0] = function () {
                                    try {
                                        ...
                                        O.isPeriodic ||
                                            ('number' == typeof O.handleId ? delete y[O.handleId] : O.handleId && (O.handleId[Ce] = null));
                                    }
                                };
                                ...
                                'number' == typeof O ? (N = y[O]) : ((N = O && O[Ce]), N || (N = O)),
                                    N && 'string' == typeof N.type
                                        ? 'notScheduled' !== N.state &&
                                          ...
                                          ('number' == typeof O ? delete y[O] : O && (O[Ce] = null), N.zone.cancelTask(N))
                                        : v.apply(t, M);
                            },
                    ));
            }
